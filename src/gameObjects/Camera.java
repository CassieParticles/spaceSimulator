...
public class Camera extends Controller{
    ...
    public void setPosition(Vector2f position){ //Creates a copy of the given vector object
    ...
    public Matrix4f getViewMatrix(){
        return new Matrix4f().identity().scale(scale).translate(new Vector3f(getFollowing()?getPlanetFollowing().getPosition():position,0).mul(-1));  //Construct a transformation matrix for all the planets
    }
}
